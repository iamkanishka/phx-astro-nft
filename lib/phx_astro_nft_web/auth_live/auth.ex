defmodule PhxAstroNftWeb.AuthLive.Auth do
  use PhxAstroNftWeb, :live_view

  @impl true
  def render(assigns) do
    ~H"""
    <section class="relative z-10 overflow-hidden flex flex-col bg-white text-black justify-center items-center px-5 pb-24 h-screen ">
      <div class="">
        <div class="mx-auto max-w-[500px] rounded-lg shadow-lg border border-stroke bg-bg-color">
          <div class="border-b border-stroke py-10 px-8 sm:p-[60px]">
            <h1 class="mb-2 text-center text-3xl font-bold ">Sign In Now</h1>

            <p class="mb-8 text-center text-base font-medium text-body-color">
              Login to your account for a faster checkout.
            </p>

            <div class="mb-9 flex items-center justify-center space-x-4">
              <button class="flex h-11 w-11 items-center justify-center rounded-md border border-stroke bg-[#353444] hover:border-white hover:bg-white">
                <svg
                  width="21"
                  height="21"
                  viewBox="0 0 21 21"
          ...
          <p class="p-6 text-center text-base font-medium text-body-color">
            Don't you have an account?
            <a href="javascript:void(0)" class="text-white hover:text-primary"> Sign up </a>
          </p>
        </div>
      </div>
    </section>
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "Auth")}
  end
