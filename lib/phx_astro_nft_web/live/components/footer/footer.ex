defmodule PhxAstroNftWeb.Components.Footer.Footer do
  use PhxAstroNftWeb, :live_component

  def render(assigns) do
    ~H"""
    <footer class="bg-bg-color pt-24 flex justify-center items-center">
      <div class="container">
        <div class=" flex flex-wrap">
          <div class="w-full px-4 sm:w-6/12 lg:w-3/12 xl:w-4/12">
            <div class="mb-16">
              <div class="max-w-[300px]">
                <a href="index.html" class="mb-7 inline-block">
                  <img src="src/images/logo.svg" alt="logo" class="h-10" />
                </a>

                <p class="mb-6 text-base font-medium text-body-color">
                ...
                <div class="flex items-center">
                  <a
                    ...
                    class="mr-5 text-white hover:text-primary"
                  >
          ...
          <div class="w-full px-4 sm:w-6/12 lg:w-3/12 xl:w-3/12">
            <div class="mb-16">
              <h2 class="mb-8 text-2xl font-bold text-white">Company</h2>

              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
                    class="mb-4 inline-block text-base font-medium text-body-color transition hover:text-white"
                  >
                    About company
                  </a>
                </li>
          ...
          <div class="w-full px-4 sm:w-6/12 lg:w-3/12 xl:w-2/12">
            <div class="mb-16">
              <h2 class="mb-8 text-2xl font-bold text-white">Customer</h2>
          ...
          <div class="w-full px-4 sm:w-6/12 lg:w-3/12 xl:w-3/12">
            <div class="mb-16">
              <h2 class="mb-8 text-2xl font-bold text-white">Subscribe Now</h2>
              ...
              <form class="relative">
                <input
                  ...
                  class="h-12 w-full rounded-lg border border-stroke bg-transparent pl-5 pr-10 text-sm font-medium text-white outline-hidden focus:border-primary"
                />
                <button
                  type="submit"
                  name="submit"
                  aria-label="submit"
                  class="absolute right-[6px] top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-md bg-primary text-white"
                >
